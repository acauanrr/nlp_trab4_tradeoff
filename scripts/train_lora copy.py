...
def main(args):
    ...
    # Isso alinha o código com a API moderna da biblioteca TRL.
    training_args = SFTConfig(
        ...
        dataset_text_field="text",  # Nome da coluna com o texto formatado
    ...
    trainer = SFTTrainer(
        model=model,
        tokenizer=tokenizer,
        args=training_args,         # Passa o SFTConfig aqui
